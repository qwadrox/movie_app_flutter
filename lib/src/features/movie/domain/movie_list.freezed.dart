...
abstract class $MovieListCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Movie> results, int page, int totalPages, int totalResults});
}
...
class _$MovieListImpl implements _MovieList {
  ...
  @override
  String toString() {
    return 'MovieList(results: $results, page: $page, totalPages: $totalPages, totalResults: $totalResults)';
  }
